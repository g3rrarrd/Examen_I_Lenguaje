    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <p>
                    <a href="{{route('directorio.entrada')}}" class="btn btn-primary">Agregar nuevo</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                           ...
                           <tr>
                                ...
                                <td>
                                    <a href="{{route('directorio.contacto', $directorio->codigoEntrada)}}" class="btn btn-info">Ver</a>
                                </td>
                                <td>
                                    <a href="{{route('directorio.destroy', $directorio->codigoEntrada)}}" class="btn btn-danger">Eliminar</a>
                                </td>
                            </tr>
